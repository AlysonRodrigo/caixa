...
public class CaixaControle {
	...
	public ResponseEntity<CaixaModel> Att(@Valid @RequestBody CaixaModel att) {
		...
		List<CaixaModel> Lista = repositorio.findByCaixa();
...
//	@GetMapping("/todo")
//	public ResponseEntity<List<CaixaModel>> data(@RequestParam(defaultValue = "")String data) {
//		List<CaixaModel> objetoLista = repositorio.findByData();
//		
...
//	}
	...
	@GetMapping("/todos")
	public ResponseEntity<List<CaixaModel>> descricao(@RequestParam(defaultValue = "")String data) {
		List<CaixaModel> objetoLista = repositorio.findByCaixa();
